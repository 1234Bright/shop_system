    ...
    <div class="card-body">
        <form action="{{ route('admin.users.update', $user) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('user_type') is-invalid @enderror" id="user_type" name="user_type" required>
                        ...
                        <option value="sales" {{ old('user_type', $user->user_type) == 'sales' ? 'selected' : '' }}>Sales Person</option>
                    </select>
                    @error('user_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-4">
                ...
                @if($user->picture)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $user->picture) }}" class="rounded img-thumbnail" style="max-height: 100px;" alt="{{ $user->name }}">
                    </div>
                @endif
